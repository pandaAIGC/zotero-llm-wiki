...
def generate_review(output_dir: Path, recent_limit: int, candidates_limit: int, scan_limit: int) -> Path:
    ...
    lines = [
        ...
        f"- Last ingest suspicious duplicate PDFs skipped: {last_stats.get('suspect_pdf_duplicates', 'n/a')}",
        f"- Last ingest previous parse failures skipped: {last_stats.get('parse_failures_skipped', 'n/a')}",
